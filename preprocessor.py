...
def WriteConfig(attitude):
  ...
  s_config.set("PATH","mri_filename",os.path.join(ctx.field("RawDirectory").value,ctx.field("PatientID").value+"_original.raw"))
  s_config.set("PATH","prostate_mask_filename",os.path.join(ctx.field("RawDirectory").value,ctx.field("PatientID").value+"_prostate.raw"))
  s_config.set("PATH","lesion_mask_filename",os.path.join(ctx.field("RawDirectory").value,ctx.field("PatientID").value+"_lesion.raw"))
  s_config.set("PATH","rectum_mask_filename",os.path.join(ctx.field("RawDirectory").value,ctx.field("PatientID").value+"_rectum.raw"))
  s_config.set("PATH","prostate_surface_filename",os.path.join(ctx.field("ObjDirectory").value,ctx.field("PatientID").value+"_prostate.obj"))
  s_config.set("PATH","lesion_surface_fileName",os.path.join(ctx.field("ObjDirectory").value,ctx.field("PatientID").value+"_lesion.obj"))
  s_config.set("PATH","rectum_surface_fileName",os.path.join(ctx.field("ObjDirectory").value,ctx.field("PatientID").value+"_rectum.obj"))
